package com.wenxun.constant;

/**
 * @author wenxun
 * @date 2024.03.09 9:47
 */
public class MessageConstant {
    ...
    public static final String PROMOTION_NOT_FOUND  = "活动无效";
    public static final String PROMOTION_TIME_ERROR  = "活动时间不满足";
